...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="./Bootstrap Privacy Page_files/bootstrap.min.css">

    <!-- Customise Bootstrap for practical grid layouts -->
    <link rel="stylesheet" href="./Bootstrap Privacy Page_files/bootstrap-custom.css">

    <!-- Insites CSS for pop-up cookie message -->
    <link rel="stylesheet" type="text/css" href="./Bootstrap Privacy Page_files/cookieconsent.min.css">

    <style></style></head>


<body data-new-gr-c-s-check-loaded="14.1094.0" data-gr-ext-installed=""><div role="dialog" aria-live="polite" aria-label="cookieconsent" aria-describedby="cookieconsent:desc" class="cc-window cc-banner cc-type-info cc-theme-block cc-bottom cc-color-override-688238583 " style="font-family: Helvetica, Calibri, Arial, Bangla706, sans-serif;"><!--googleoff: all--><span id="cookieconsent:desc" class="cc-message">This website uses cookies to ensure you get the best experience on our website. <a aria-label="learn more about cookies" role="button" tabindex="0" class="cc-link" href="https://mywebsite.github.io/privacy.html" rel="noopener noreferrer nofollow" target="_blank">Learn more</a></span><div class="cc-compliance"><a aria-label="dismiss cookie message" role="button" tabindex="0" class="cc-btn cc-dismiss">Got it!</a></div><!--googleon: all--></div>
...
<!-- jQuery library -->
<script src="./Bootstrap Privacy Page_files/jquery.min.js.download"></script>
<!-- Popper JS -->
<script src="./Bootstrap Privacy Page_files/popper.min.js.download"></script>
<!-- Latest compiled JavaScript -->
<script src="./Bootstrap Privacy Page_files/bootstrap.min.js.download"></script>

<!-- JavaScript for Cookie Consent Popup Message -->
<script src="./Bootstrap Privacy Page_files/cookieconsent.min.js.download" data-cfasync="false"></script>
<script>
...
<style>		@font-face {				font-family: Bangla706;				src: local('Siyam Rupali');				unicode-range: U+0980-09FF;		}		body {			font-family: Bangla706, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";		}	</style></body><grammarly-desktop-integration data-grammarly-shadow-root="true"></grammarly-desktop-integration></html>
